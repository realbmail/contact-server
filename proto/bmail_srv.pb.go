...
func (x *DecryptRequest) Reset() {
	*x = DecryptRequest{}
	mi := &file_bmail_srv_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DecryptRequest) Descriptor() ([]byte, []int) {
	return file_bmail_srv_proto_rawDescGZIP(), []int{12}
}

func (x *DecryptRequest) GetSender() string {
	if x != nil {
		return x.Sender
	}
	return ""
...
func (x *DecryptRequest) GetAdminKey() string {
	if x != nil {
		return x.AdminKey
	}
	return ""
...
func (x *DecryptRequest) GetMailReceiver() string {
	if x != nil {
...
var file_bmail_srv_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x06, 0x75, 0x6e, 0x62, 0x69, 0x6e, 0x64, 0x22, 0x7e, 0x0a, 0x0e, 0x44, 0x65, 0x63,
	0x72, 0x79, 0x70, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x73,
	0x65, 0x6e, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x6e,
	0x64, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x4b, 0x65, 0x79, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x4b, 0x65, 0x79, 0x12,
	...
	0x76, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74,
...
var file_bmail_srv_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_bmail_srv_proto_goTypes = []any{
	...
	(*DecryptRequest)(nil),   // 12: DecryptRequest
	nil,                      // 13: EmailReflects.ReflectsEntry
}
var file_bmail_srv_proto_depIdxs = []int32{
	8,  // 0: ContactOperation.contacts:type_name -> ContactItem
	13, // 1: EmailReflects.reflects:type_name -> EmailReflects.ReflectsEntry
